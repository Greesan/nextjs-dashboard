  ...
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      <Link
        ...
        href="/"
      >
        <div className="w-32 text-white bg-black md:w-40">
          <AcmeLogo />
        </div>
      </Link>
      <div className="flex grow flex-row justify-between space-x-2 bg-black	 md:flex-col md:space-x-0 md:space-y-2">
        <NavLinks />
